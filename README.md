...
https://github.com/zyhdf5/docker_image_pusher
...
在国内服务器pull镜像：<br>
```
docker pull registry.cn-shanghai.aliyuncs.com/shrimp-images/alpine
```
registry.cn-shanghai.aliyuncs.com 即 ALIYUN_REGISTRY<br>
